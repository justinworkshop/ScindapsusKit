...
public abstract class MyRefactoringDialog extends JavaExtractSuperBaseDialog {

    public static List<PsiMethod> outDeps;

    public MyRefactoringDialog(@Nullable Project project, PsiClass clz, List<MemberInfo> infos, List<PsiMethod> hasOutDeps) {
        super(project, clz, infos, ExtractInterfaceHandler.getRefactoringName());
        MyRefactoringDialog.outDeps = hasOutDeps;
        init();
    ...
    protected JComponent createCenterPanel() {
        ...
        final MemberSelectionPanel memberSelectionPanel = new StaticMemberSelectionPanel(getTableTitle(),
                myMemberInfos, "Have deps", outDeps);
